<template>
    <div class="calculator">
        ...
        <Button label="AC" double @onClick="clearMemory"></Button>
        <Button label="DEL" @onClick="deleteLast"></Button>
    ...
    methods: {
        ...
        deleteLast() {
            if (this.displayValue !== "0") {
                var newValue = this.displayValue.substring(0, this.displayValue.length - 1)
...
.calculator {
    ...
    grid-template-rows: 56px 48px 48px 48px 48px 48px 48px;
    }
